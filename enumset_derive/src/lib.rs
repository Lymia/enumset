...
fn enum_set_type_impl(info: EnumSetInfo, warnings: Vec<(Span, &'static str)>) -> SynTokenStream {
    ...
    quote! {
        const _: () = {
            #[automatically_derived]
            #[doc(hidden)]
            #vis struct __EnumSetConstHelper;

            #[automatically_derived]
            #[doc(hidden)]
            impl #name {
                /// Creates a new enumset helper.
                #[deprecated(note = "This method is an internal implementation detail generated \
                                     by the `enumset` crate's procedural macro. It should not be \
                                     used directly.")]
                #[doc(hidden)]
                pub const fn __impl_enumset_internal__const_helper(
                    self,
                ) -> __EnumSetConstHelper {
                    __EnumSetConstHelper
                }
            }
