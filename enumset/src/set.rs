...
#[doc(hidden)]
impl<T: EnumSetType> EnumSet<T> {
    /// Creates a new enumset helper.
    #[deprecated(note = "This method is an internal implementation detail generated by the \
                         `enumset` crate's procedural macro. It should not be used directly.")]
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub const fn __impl_enumset_internal__const_helper(&self) -> T::ConstHelper {
    ...
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub const fn __impl_enumset_internal__const_only(self) -> Self {
        self
    }
}
